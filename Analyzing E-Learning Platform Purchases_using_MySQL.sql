CREATE DATABASE elearning_db; USE elearning_db;
CREATE TABLE learners (learner_id INT AUTO_INCREMENT PRIMARY KEY,full_name VARCHAR(100) NOT NULL,country VARCHAR(50));
CREATE TABLE courses (course_id INT AUTO_INCREMENT PRIMARY KEY,course_name VARCHAR(100) NOT NULL,category VARCHAR(50),unit_price DECIMAL(10,2));
...
('MySQL Basics', 'Database', 2000),
('Python Programming', 'Programming', 3000),
('Web Development', 'Development', 2500),
('Data Science', 'Analytics', 4000),
